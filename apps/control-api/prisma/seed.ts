...
const defaultMenus: DefaultMenuDefinition[] = [
  ...
  { code: 'channel_accounts', parentCode: 'channels', name: '渠道账号', type: 'MENU', path: '/channels/accounts', component: 'channels/accounts/page', icon: 'KeyRound', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 20 },
  { code: 'channel_templates', parentCode: 'channels', name: '渠道模板', type: 'MENU', path: '/channels/templates', component: 'channels/templates/page', icon: 'FileText', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 30 },
  { code: 'channel_route_rules', parentCode: 'channels', name: '路由规则', type: 'MENU', path: '/channels/route-rules', component: 'channels/route-rules/page', icon: 'GitBranch', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 40 },
  { code: 'channel_jobs', parentCode: 'channels', name: '发布任务', type: 'MENU', path: '/channels/jobs', component: 'channels/jobs/page', icon: 'ClipboardCheck', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 50 },
  { code: 'channel_deliveries', parentCode: 'channels', name: '投递记录', type: 'MENU', path: '/channels/deliveries', component: 'channels/deliveries/page', icon: 'Activity', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 60 },
  { code: 'channel_replies', parentCode: 'channels', name: '回复记录', type: 'MENU', path: '/channels/replies', component: 'channels/replies/page', icon: 'MessageSquareReply', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 70 },
  { code: 'channel_sender', parentCode: 'channels', name: 'Sender 投递', type: 'MENU', path: '/channels/sender', component: 'channels/sender/page', icon: 'Send', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 80 },
  { code: 'channel_release', parentCode: 'channels', name: '发布治理', type: 'MENU', path: '/channels/release', component: 'channels/release/page', icon: 'Rocket', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 90 },
  ...
  { code: 'approvals', parentCode: 'security_center', name: '审批中心', type: 'MENU', path: '/approvals', component: 'approvals/page', icon: 'ClipboardCheck', permissionCode: PERMISSION_CODES.securityApprovalView, sortOrder: 60 },
  ...
  { code: 'approval_audits', parentCode: 'security_center', name: '审批审计', type: 'MENU', path: '/approval-audits', component: 'approval-audits/page', icon: 'ScrollText', permissionCode: PERMISSION_CODES.securityApprovalView, sortOrder: 70 },
  ...
  { code: 'audit', parentCode: 'security_center', name: '审计日志', type: 'MENU', path: '/audit', component: 'audit/page', icon: 'ScrollText', permissionCode: PERMISSION_CODES.securityAuditView, sortOrder: 80 },
