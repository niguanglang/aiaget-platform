...
const defaultMenus: DefaultMenuDefinition[] = [
  ...
  { code: 'agent_platform', name: 'Agent 中心', type: 'DIRECTORY', icon: 'Bot', sortOrder: 20 },
  { code: 'agents', parentCode: 'agent_platform', name: 'Agent 管理', type: 'MENU', path: '/agents', component: 'agents/page', icon: 'Bot', permissionCode: PERMISSION_CODES.agentAgentView, sortOrder: 10 },
  { code: 'agent_teams', parentCode: 'agent_platform', name: 'Agent 协作', type: 'MENU', path: '/agent-teams', component: 'agent-teams/page', icon: 'GitBranch', permissionCode: PERMISSION_CODES.agentTeamView, sortOrder: 20 },
  ...
  { code: 'skills', parentCode: 'agent_platform', name: '技能资产', type: 'MENU', path: '/skills', component: 'skills/page', icon: 'Blocks', permissionCode: PERMISSION_CODES.skillHubView, sortOrder: 30 },
  { code: 'prompts', parentCode: 'agent_platform', name: '提示词中心', type: 'MENU', path: '/prompts', component: 'prompts/page', icon: 'FileText', permissionCode: PERMISSION_CODES.promptTemplateView, sortOrder: 40 },
  { code: 'models', parentCode: 'agent_platform', name: '模型中心', type: 'MENU', path: '/models', component: 'models/page', icon: 'KeyRound', permissionCode: PERMISSION_CODES.modelConfigView, sortOrder: 50 },
  { code: 'knowledge', parentCode: 'agent_platform', name: '知识库中心', type: 'MENU', path: '/knowledge', component: 'knowledge/page', icon: 'Database', permissionCode: PERMISSION_CODES.knowledgeBaseView, sortOrder: 60 },
  { code: 'knowledge_activity', parentCode: 'knowledge', name: '活动总览', type: 'MENU', path: '/knowledge/activity', component: 'knowledge/activity/page', icon: 'Activity', permissionCode: PERMISSION_CODES.knowledgeBaseView, sortOrder: 10 },
  { code: 'knowledge_tasks', parentCode: 'knowledge', name: '文档处理任务', type: 'MENU', path: '/knowledge/tasks', component: 'knowledge/tasks/page', icon: 'ClipboardCheck', permissionCode: PERMISSION_CODES.knowledgeBaseView, sortOrder: 20 },
  ...
  { code: 'role_scenarios', parentCode: 'customer_delivery', name: '岗位场景', type: 'MENU', path: '/role-scenarios', component: 'role-scenarios/page', icon: 'Workflow', permissionCode: PERMISSION_CODES.roleScenarioView, sortOrder: 20 },
  { code: 'solution_packages', parentCode: 'customer_delivery', name: '落地方案', type: 'MENU', path: '/solution-packages', component: 'solution-packages/page', icon: 'FileCheck2', permissionCode: PERMISSION_CODES.solutionPackageView, sortOrder: 30 },
  { code: 'delivery_reviews', parentCode: 'customer_delivery', name: '验收复盘', type: 'MENU', path: '/delivery-reviews', component: 'delivery-reviews/page', icon: 'ClipboardCheck', permissionCode: PERMISSION_CODES.deliveryReviewView, sortOrder: 40 },
  { code: 'delivery_assets', parentCode: 'customer_delivery', name: '成果资产', type: 'MENU', path: '/delivery-assets', component: 'delivery-assets/page', icon: 'ArchiveRestore', permissionCode: PERMISSION_CODES.deliveryAssetView, sortOrder: 50 },
  { code: 'customer_success_plans', parentCode: 'customer_delivery', name: '客户成功计划', type: 'MENU', path: '/customer-success-plans', component: 'customer-success-plans/page', icon: 'TrendingUp', permissionCode: PERMISSION_CODES.customerSuccessView, sortOrder: 60 },
  { code: 'customer_success_actions', parentCode: 'customer_delivery', name: '成功行动', type: 'MENU', path: '/customer-success-actions', component: 'customer-success-actions/page', icon: 'ListChecks', permissionCode: PERMISSION_CODES.customerSuccessActionView, sortOrder: 70 },
  { code: 'customer_success_opportunities', parentCode: 'customer_delivery', name: '续约机会', type: 'MENU', path: '/customer-success-opportunities', component: 'customer-success-opportunities/page', icon: 'Handshake', permissionCode: PERMISSION_CODES.customerSuccessOpportunityView, sortOrder: 80 },
  ...
  { code: 'channel_operations', name: '渠道发布', type: 'DIRECTORY', icon: 'RadioTower', sortOrder: 40 },
  { code: 'channels', parentCode: 'channel_operations', name: '渠道配置', type: 'MENU', path: '/channels', component: 'channels/page', icon: 'RadioTower', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 10 },
  ...
  { code: 'channel_release_control', parentCode: 'channel_release', name: '发布控制台', type: 'MENU', path: '/channels/release/control', component: 'channels/release/control/page', icon: 'Rocket', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 10 },
  { code: 'channel_release_pipeline', parentCode: 'channel_release', name: '发布流水线', type: 'MENU', path: '/channels/release/pipeline', component: 'channels/release/pipeline/page', icon: 'GitBranch', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 20 },
  { code: 'channel_release_gate', parentCode: 'channel_release', name: '发布门禁', type: 'MENU', path: '/channels/release/gate', component: 'channels/release/gate/page', icon: 'ShieldCheck', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 30 },
  { code: 'channel_release_automation', parentCode: 'channel_release', name: '自动化策略', type: 'MENU', path: '/channels/release/automation', component: 'channels/release/automation/page', icon: 'Workflow', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 40 },
  { code: 'channel_release_self_healing', parentCode: 'channel_release', name: '自愈任务', type: 'MENU', path: '/channels/release/self-healing', component: 'channels/release/self-healing/page', icon: 'Wrench', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 50 },
  { code: 'channel_release_scheduler', parentCode: 'channel_release', name: '发布排期', type: 'MENU', path: '/channels/release/scheduler', component: 'channels/release/scheduler/page', icon: 'ClipboardCheck', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 60 },
  { code: 'channel_release_reports', parentCode: 'channel_release', name: '发布报告', type: 'MENU', path: '/channels/release/reports', component: 'channels/release/reports/page', icon: 'BarChart3', permissionCode: PERMISSION_CODES.channelPublishView, sortOrder: 70 },
  { code: 'plugin_ecosystem', name: '插件生态', type: 'DIRECTORY', icon: 'Boxes', sortOrder: 50 },
  { code: 'plugins', parentCode: 'plugin_ecosystem', name: '插件中心', type: 'MENU', path: '/plugins', component: 'plugins/page', icon: 'Boxes', permissionCode: PERMISSION_CODES.pluginCenterView, sortOrder: 10 },
  { code: 'external_access', name: '外部接入', type: 'DIRECTORY', icon: 'Cable', sortOrder: 60 },
  { code: 'api_keys', parentCode: 'external_access', name: 'API Key 管理', type: 'MENU', path: '/api-keys', component: 'api-keys/page', icon: 'KeySquare', permissionCode: PERMISSION_CODES.systemApiKeyView, sortOrder: 10 },
  { code: 'api_key_observability', parentCode: 'api_keys', name: '调用观测', type: 'MENU', path: '/api-keys/observability', component: 'api-keys/observability/page', icon: 'LineChart', permissionCode: PERMISSION_CODES.systemApiKeyView, sortOrder: 10 },
  { code: 'api_key_webhook_deliveries', parentCode: 'api_keys', name: 'Webhook 投递', type: 'MENU', path: '/api-keys/webhook-deliveries', component: 'api-keys/webhook-deliveries/page', icon: 'Webhook', permissionCode: PERMISSION_CODES.systemApiKeyView, sortOrder: 20 },
  { code: 'api_reference', parentCode: 'external_access', name: '接口文档', type: 'MENU', path: '/api-reference', component: 'api-reference/page', icon: 'BookOpen', permissionCode: PERMISSION_CODES.systemApiKeyView, sortOrder: 20 },
  { code: 'observability_center', name: '可观测中心', type: 'DIRECTORY', icon: 'Activity', sortOrder: 70 },
  { code: 'monitor', parentCode: 'observability_center', name: '运行监控', type: 'MENU', path: '/monitor', component: 'monitor/page', icon: 'Activity', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 10 },
  { code: 'monitor_observability', parentCode: 'monitor', name: '可观测性质量', type: 'MENU', path: '/monitor/observability', component: 'monitor/observability/page', icon: 'LineChart', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 10 },
  { code: 'runtime_workflows', parentCode: 'observability_center', name: 'Runtime 工作流', type: 'MENU', path: '/runtime/workflows', component: 'runtime/workflows/page', icon: 'Workflow', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 20 },
  { code: 'platform_usage', parentCode: 'observability_center', name: '平台用量', type: 'MENU', path: '/monitor/platform-usage', component: 'monitor/platform-usage/page', icon: 'BarChart3', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 30 },
  { code: 'platform_usage_events', parentCode: 'platform_usage', name: '平台事件', type: 'MENU', path: '/monitor/platform-usage/events', component: 'monitor/platform-usage/events/page', icon: 'Activity', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 10 },
  { code: 'platform_usage_ledger', parentCode: 'platform_usage', name: '用量账本', type: 'MENU', path: '/monitor/platform-usage/ledger', component: 'monitor/platform-usage/ledger/page', icon: 'Coins', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 20 },
  { code: 'platform_usage_trends', parentCode: 'platform_usage', name: '用量趋势', type: 'MENU', path: '/monitor/platform-usage/trends', component: 'monitor/platform-usage/trends/page', icon: 'LineChart', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 30 },
  { code: 'platform_usage_alerts', parentCode: 'platform_usage', name: '事件告警', type: 'MENU', path: '/monitor/platform-usage/alerts', component: 'monitor/platform-usage/alerts/page', icon: 'BellRing', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 40 },
  { code: 'platform_usage_notifications', parentCode: 'platform_usage', name: '通知记录', type: 'MENU', path: '/monitor/platform-usage/notifications', component: 'monitor/platform-usage/notifications/page', icon: 'BellRing', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 50 },
  { code: 'platform_usage_tasks', parentCode: 'platform_usage', name: '治理任务', type: 'MENU', path: '/monitor/platform-usage/tasks', component: 'monitor/platform-usage/tasks/page', icon: 'ListChecks', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 60 },
  { code: 'billing', name: '计费成本', type: 'MENU', path: '/billing', component: 'billing/page', icon: 'Coins', permissionCode: PERMISSION_CODES.billingCenterView, sortOrder: 85 },
  ...
  { code: 'settings_notification_policy', parentCode: 'settings', name: '通知策略', type: 'MENU', path: '/settings/notification-policy', component: 'settings/notification-policy/page', icon: 'BellRing', permissionCode: PERMISSION_CODES.systemSettingsView, sortOrder: 10 },
  { code: 'settings_notification_policy_snapshots', parentCode: 'settings_notification_policy', name: '策略快照', type: 'MENU', path: '/settings/notification-policy/snapshots', component: 'settings/notification-policy/snapshots/page', icon: 'FileArchive', permissionCode: PERMISSION_CODES.systemSettingsView, sortOrder: 10 },
  { code: 'settings_production_readiness', parentCode: 'settings', name: '生产就绪检查', type: 'MENU', path: '/settings/production-readiness', component: 'settings/production-readiness/page', icon: 'Rocket', permissionCode: PERMISSION_CODES.systemSettingsView, sortOrder: 20 },
  ...
  { code: 'storage', parentCode: 'system_management', name: '文件存储', type: 'MENU', path: '/storage', component: 'storage/page', icon: 'HardDrive', permissionCode: PERMISSION_CODES.storageObjectView, sortOrder: 90 },
...
const retiredMenuCodes = ['agent_center'] as const;
