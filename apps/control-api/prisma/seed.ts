...
const defaultMenus: DefaultMenuDefinition[] = [
  ...
  { code: 'approvals', parentCode: 'security_center', name: '高危工具审批', type: 'MENU', path: '/approvals', component: 'approvals/page', icon: 'ClipboardCheck', permissionCode: PERMISSION_CODES.securityApprovalView, sortOrder: 60 },
