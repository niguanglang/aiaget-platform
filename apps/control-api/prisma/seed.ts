...
const defaultMenus: DefaultMenuDefinition[] = [
  ...
  { code: 'agent_platform', name: 'Agent 平台', type: 'DIRECTORY', icon: 'Bot', sortOrder: 20 },
  ...
  { code: 'knowledge_activity', parentCode: 'knowledge', name: '文档处理任务', type: 'MENU', path: '/knowledge/activity', component: 'knowledge/activity/page', icon: 'ClipboardCheck', permissionCode: PERMISSION_CODES.knowledgeBaseView, sortOrder: 10 },
  { code: 'knowledge_health', parentCode: 'knowledge', name: '检索健康度', type: 'MENU', path: '/knowledge/health', component: 'knowledge/health/page', icon: 'ServerCog', permissionCode: PERMISSION_CODES.knowledgeBaseView, sortOrder: 20 },
  ...
  { code: 'channel_operations', name: '渠道运营', type: 'DIRECTORY', icon: 'RadioTower', sortOrder: 40 },
  ...
  { code: 'observability_center', name: '监控与可观测性', type: 'DIRECTORY', icon: 'Activity', sortOrder: 70 },
  ...
  { code: 'platform_usage', parentCode: 'observability_center', name: '平台事件与用量', type: 'MENU', path: '/monitor/platform-usage', component: 'monitor/platform-usage/page', icon: 'BarChart3', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 30 },
  { code: 'platform_usage_alerts', parentCode: 'platform_usage', name: '事件告警', type: 'MENU', path: '/monitor/platform-usage/alerts', component: 'monitor/platform-usage/alerts/page', icon: 'BellRing', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 10 },
  { code: 'platform_usage_notifications', parentCode: 'platform_usage', name: '通知记录', type: 'MENU', path: '/monitor/platform-usage/notifications', component: 'monitor/platform-usage/notifications/page', icon: 'BellRing', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 20 },
  { code: 'platform_usage_tasks', parentCode: 'platform_usage', name: '治理任务', type: 'MENU', path: '/monitor/platform-usage/tasks', component: 'monitor/platform-usage/tasks/page', icon: 'ListChecks', permissionCode: PERMISSION_CODES.monitorLogView, sortOrder: 30 },
