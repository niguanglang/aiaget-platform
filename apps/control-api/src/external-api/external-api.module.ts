...
@Module({
  ...
  providers: [BillingService, ExternalApiKeyService, ExternalApiService, ExternalWebhookService, ExternalChannelCallbackService, ExternalChannelSenderService, ExternalChannelRolloutGateService],
