...
export function AgentFormPanel({
  ...
  return (
    <section className={isPage ? 'grid rounded-lg border bg-background shadow-sm' : 'fixed inset-y-0 right-0 z-30 flex w-full max-w-xl flex-col border-l bg-background shadow-xl'}>
