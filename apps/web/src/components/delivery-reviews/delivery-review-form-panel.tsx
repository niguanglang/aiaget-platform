...
function defaults(review?: DeliveryReviewDetail | null): DeliveryReviewFormValues {
  return {
    ...
    delivered_scope: review?.delivered_scope ?? '完成售前方案样板、引用来源清单、风险提示模板、权限审计说明和验收清单。',
    acceptance_summary: review?.acceptance_summary ?? '客户确认样板成果可用于试点验收，引用来源完整，关键风险均有处理建议。',
