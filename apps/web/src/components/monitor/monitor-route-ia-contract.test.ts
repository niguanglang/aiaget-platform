...
test('runtime workflows page owns runtime workflow API calls', () => {
  ...
  assert.match(sharedPanelsSource, /latestFailure\.failure_event_id/);
  assert.match(sharedPanelsSource, /latestFailure\.failure_trace_id/);
  assert.match(sharedPanelsSource, /latestFailure\.failure_request_id/);
  assert.match(sharedPanelsSource, /查看失败事件/);
  assert.match(sharedPanelsSource, /查看失败 Trace/);
  assert.match(sharedPanelsSource, /查看失败请求/);
  assert.match(sharedPanelsSource, /查看最近失败事件/);
  assert.match(sharedPanelsSource, /查看最近失败 Trace/);
  assert.match(sharedPanelsSource, /查看最近失败请求/);
