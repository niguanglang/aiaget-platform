...
| List row actions | `tool-content.tsx` | `copyTool`, `enableTool`, `disableTool`, `deleteTool` | View/edit route links, copy/status/delete mutations |
| Detail top actions | `tool-detail-content.tsx` | copy/status/delete + edit route | Edit should navigate to `/tools/[id]/edit` |
