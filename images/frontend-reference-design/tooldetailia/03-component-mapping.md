...
| Header and object actions | `ToolDetailHeader` | `ToolDetail`, `copyTool`, `enableTool`, `disableTool`, `deleteTool` | Edit links to `/tools/${toolId}/edit`; delete opens confirmation. |
...
| Delete confirmation | `ToolConfirmDialog` | `deleteTool` | Destructive action requires confirmation. |
